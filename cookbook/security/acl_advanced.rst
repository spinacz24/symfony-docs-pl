...
obiekt tożsamości obiektu. Za każdym razem, gdy chce się pobrać listę ACL dla
...
- *acl_security_identities*: Tabela rejestrująca wszystkie tożsamosci
...
Klasa ACL dostarcza dwie metody dla określania, czy itożsamość bezpieczeństwa
